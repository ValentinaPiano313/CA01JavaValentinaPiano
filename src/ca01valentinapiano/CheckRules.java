...
// The purpose of the CheckRules class is to validate that the attributes of the object 
// adhere to specific rules necessary for the proper functioning of the program
